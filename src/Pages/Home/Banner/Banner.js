        ...
        <div className="hero bg-base-200 rounded-lg mt-4">
            <div className="hero-content flex-col lg:flex-row-reverse gap-8 md:gap-14 justify-between items-center">
                ...
                <div className='w-full lg:w-full'>
                    ...
                    <p className='font-barlow my-4 md:my-8 w-11/12 text-xl leading-loose'>We're an export-import company in Bangladesh, specializing in high-quality coal, stone, and onion products. Trust us to deliver excellence and reliability, whether you need products for construction, landscaping, or cooking.</p>
                    <div className='mt-8 font-barlow'>
                        <Link to="/contact-us"><PrimaryButton>Contact US <BsChevronDoubleRight /></PrimaryButton></Link>
                    </div>
                </div>
            </div>
        </div>
