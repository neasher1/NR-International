...
const Licensing = () => {
    return (
        <div className='my-8'>
            ...
            <p className='mt-2'>If you have any questions or concerns about licensing related to our products or services, please feel free to contact us. Our team is dedicated to providing transparent and trustworthy licensing practices to ensure that our clients can operate with confidence and peace of mind.
            </p>
        </div>
    );
};
